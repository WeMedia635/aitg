  ...
  <div class="top-bar" style="background-image: url('images/bg/top-bar.jpg')">
    <div class="container">
      <div class="row">
        <div class="col-sm-8">
          <div class="info-bar">
            <p>E-63, MIDC Waluj, Aurangabad - 431136, Maharashtra, India.</p>
          </div>          
        </div>
        <div class="col-sm-4 hidden-xs">
          <ul class="top-social-icon">
            ...
            <li><a href="http://instagram.com" target="_blank"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a></li>
            <li><a href="http://pinterest.com" target="_blank"><i class="fa fa-wordpress" aria-hidden="true"></i></a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="nav-bar">
    <div class="container">
      <div class="row">
        <div class="col-sm-4">
          <div class="logo">
            <a href="index.php"><img src="images/logo-real.svg" alt="logo"></a>
          </div>
        </div>
        <div class="col-sm-8 contact-info-header">
          <div class="row">
           	<div class="col-sm-3">
              <div class="info-nav">
    	       	  <div class="info-nav-heading">Phone Number</div>
                <div class="info-nav-dtl"><a href="tel:#">+91 240 6625613/4</a></div>
              </div>
    	      </div>
    	      <div class="col-sm-3">
              <div class="info-nav">
                <div class="info-nav-heading">Email Address:</div>
                <div class="info-nav-dtl"><a href="mailto:#">info@macpl.com</a></div>
              </div>
            </div>
    	      <div class="col-sm-3">
              <div class="info-nav">
                <div class="info-nav-heading">CNI</div>
                <div class="info-nav-dtl">U29130MH1988PTC046951</div>
              </div>
            </div>
    	      <div class="col-sm-3">
              ...
              <ul>
                ...
                <li><a href="#">Solutions</a>
                  <ul>
                    ...
                    <li><a href="solutions-details.html">Solutions Details</a></li>
                  </ul>
                </li>
